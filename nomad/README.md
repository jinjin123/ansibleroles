...
## Github地址
https://github.com/jimmy/Ansible-roles/tree/master/nomad
...
生成证书
```bash
curl -sSL https://cdn.jsdelivr.net/gh/jimmy/script@master/shell/cfssl.sh | bash -s - vault server.global.nomad client.global.nomad
```
